...
export type EmbedPayload =
  ...
  // Composite: text chunk + embedded media sent together → one aggregated embedding
  | { type: 'composite'; textContent: string; mediaParts: Array<{ mimeType: string; base64: string }> };
